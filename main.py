...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/home/gyang/MAE-GAN/test_image', type=str,
                        help='dataset path')
...
def main(args):
    ...
    dataset = CustomDataset(args.data_path) # here needs to be modified!!!
    ...
    param_groups = optim_factory.add_weight_decay(model_without_ddp, weight_decay=args.weight_decay)
