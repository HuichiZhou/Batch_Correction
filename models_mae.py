...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=512, patch_size=16, in_chans=3,
        ...
        self.discriminate_batch =  nn.Linear(embed_dim, 51, bias = True)
        # --------------------------------------------------------------------------
    ...
    def discriminator_batch(self, currupt_img):
    ...
    def forward(self, imgs,batch_label, mask_ratio=0.75):
